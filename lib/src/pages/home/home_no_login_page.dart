...
class HomeNoLoginPage extends StatefulWidget {
  @override
  _HomeNoLoginPageState createState() => _HomeNoLoginPageState();
}

class _HomeNoLoginPageState extends State<HomeNoLoginPage> {
  int _current = 0;
